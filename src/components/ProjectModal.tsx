      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        ...
        <div className="flex min-h-full items-center justify-center p-4 sm:p-6 my-auto">
          ...
          <motion.div
            ...
            className="relative bg-white rounded-3xl max-w-3xl w-full shadow-2xl overflow-hidden z-10 max-h-[85vh] flex flex-col my-auto"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-20 p-2.5 rounded-full bg-white/90 backdrop-blur-md text-[#2D2D2D] hover:bg-white hover:scale-105 transition-all shadow-md"
                ...
                <div className="pt-6 border-t border-gray-100 flex items-center justify-between gap-4">
                  ...
                  {project.link && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-[#2D2D2D] text-white font-semibold text-sm hover:bg-black transition-all shadow-md shrink-0 font-epilogue"
                    >
